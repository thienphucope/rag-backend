...
sentence_model = SentenceTransformer('all-MiniLM-L6-v2')  # Tải mô hình cục bộ
...
def get_embeddings(texts):
    try:
        embeddings = sentence_model.encode(texts, convert_to_numpy=True)  # Tạo embedding cục bộ
        return embeddings
