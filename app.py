...
def summarize_and_store(session_id):
    ...
    prompt = f"""
    "Summarize the conversation between Ope Watson and {username} in a single paragraph, capturing only key facts such as appointments, promises, user details, or major decisions. Format each fact as 'Ope notes that...' and exclude unnecessary details. Respond without any additional commentary."
